...
<div class="bg-stone-50 py-8 min-h-screen">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <a href="{{ url()->previous() }}" class="inline-flex items-center mb-6 text-sm text-blue-600 hover:underline">
            ← Kembali
        </a>
        ...
        <div class="flex flex-col md:flex-row -mx-4">
            <div class="md:flex-1 px-4">
                <div class="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                    <img class="w-full h-full object-cover rounded-lg shadow"
                        src="{{ "/storage/".$produk->gambar }}" alt="{{ $produk->nama }}" />
                </div>
            ...
            <div class="md:flex-1 px-4">
                ...
                <div>
                    ...
                    <span class="text-1xl font-bold text-black-800">Kategori:</span>
                    <p class="text-gray-400 text-sm mt-2 mb-3">
